...
print("Inh...")
orig = pd.read_excel(os.path.normpath(os.path.expanduser("~/Desktop/Inh_DBPedia.xlsx")))
...
print("Conv...")
res.to_excel(os.path.normpath(os.path.expanduser("~/Desktop/DBPedia_FCA.xlsx")))
