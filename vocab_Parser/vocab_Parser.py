...
a = rm_main(pd.read_excel(r"C:\Users\marco\Desktop\Internship\Results\LOV_Latest.xlsx", sheet_name=1, header=None), pd.read_excel(r"C:\Users\marco\Desktop\Internship\Results\LOV_Latest.xlsx"))